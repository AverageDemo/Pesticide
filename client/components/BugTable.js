...
export default function BugTable({ bugArray, project, user }) {
  const statusOptions = {
      ...
      <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
          <div className="pb-3 text-right">
            {user && (user.role > 1 || user._id === project.author) && (
                ...
                {bugArray.length > 0 ? (
                  bugArray.map((bug) => (
                    <tr key={bug.name}>
                        ...
                        <div className="flex items-center">
                          <div>
                            <div className="text-sm font-medium text-gray-900">
                              <Link href={`/bugs/${project.slug}/${bug.slug}`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {moment(bug.date).format("MM-DD-yyyy")}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <Link href={`/bugs/${project.slug}/${bug.slug}/edit`}>
                          <a className="hover:text-gray-600">
